...
export function useGetSeriesColection(id?: string) {
  const md5Hash = md5(
  ...
  const seriesColection = data;
  const seriesColectionFetching = isFetching;
  const seriesColectionError = error;
  const seriesColectionRefetch = refetch;
  return {
    seriesColection,
    seriesColectionFetching,
    seriesColectionError,
